...
- **RNF-4 (fidelidad)** — **gate compareWithDesign** (SPEC-QA-001): diff contra `11-faq.html` bajo umbral (desktop+mobile). _(Estado consistente: cerrado por defecto.)_ Self-baselines (`toHaveScreenshot`) retirados per [ADR-0014](/adr/0014-design-gate-sole-visual-regression.md).
