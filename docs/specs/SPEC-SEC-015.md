...
- **RF-3 (`<head>`/SEO base)** — `BaseLayout` recibe `seo` real (title, description, canonical desde `PUBLIC_SITE_URL`, Open Graph básico, favicon, `lang`). *(JSON-LD/sitemap/robots avanzados → EPIC-07, diferido.)*
